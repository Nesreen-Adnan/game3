...
export default {
    data() {
        return {
            audios: {
                click: "../puplic/sounds/click.mp3",
                stop: "../puplic/sounds/bottles.mp3",
                button: "../puplic/sounds/click-button.mp3",
                begain: "../puplic/sounds/begain.mp3",
                win: "../puplic/sounds/win.mp3",
                correct: "../puplic/sounds/correct.mp3",
            },
        };
    },
    methods: {
